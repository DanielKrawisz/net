...
namespace io::log {
    ...
    */
#define DATA_LOG(sev) \
    BOOST_LOG_SEV((io::log::global_log::get ()),(io::log::severity_level::sev)) << \
        ::io::log::indent_string (::io::log::indent::depth ())
...
#define DATA_LOG_CHANNEL(channel, sev) \
    BOOST_LOG_CHANNEL_SEV((io::log::global_log::get()),(channel),(io::log::severity_level::sev)) << \
        ::io::log::indent_string (::io::log::indent::depth ())
