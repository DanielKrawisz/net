...
namespace net {
    template <typename X> using writer = data::writer<X>;
    template <typename X> using reader = data::reader<X>;
...
namespace net {
    ...
    using pctstr = data::encoding::percent::string;
    ...
    struct path : pctstr {
        using data::encoding::percent::string::string;
    ...
    using URI = data::encoding::percent::URI;
...
namespace net {
    ...
    bool inline authority::valid () const {
        return valid (data::encoding::percent::encode (*this));
    }

    maybe<UTF8> inline authority::user_info () const {
