...
namespace io::random {
    ...
    data::ptr<source> StrongEntropy {};

    data::ptr<source> WeakEntropy {};
    ...
    void init (options o) {
        ...
        if (o.secure && o.strength != 112 && o.strength != 128 && o.strength != 192 && o.strength != 256)
            throw data::exception {} << "invalid value for secure RNG strength (" << o.strength << "). Allowed values are 112, 128, 192, and 256";

        if (bool (o.seed)) {
            WeakEntropy = std::static_pointer_cast<source> (
                std::make_shared<fixed_entropy> (
                    data::crypto::NIST::Hash_df<data::crypto::hash::SHA2_512, data::uint32_big {1016}> (*o.seed)));
        ...
        Casual = data::ptr<data::crypto::random::default_casual_random> (
            new data::crypto::random::default_casual_random {*CasualEntropy, 1 << 30});
        ...
        if (o.strength == 112) {
            using nist = data::crypto::NIST::CTR_DRBG<21, data::crypto::cipher::block::TDEA3>;
            if (o.additional) {
                using secure = automatic_reseed<data::crypto::NIST::auto_generate_with_additional_entropy<nist>>;
            ...
            using nist = data::crypto::NIST::Hash_DRBG<data::crypto::hash::SHA2_256>;
            if (o.additional) {
                using secure = automatic_reseed<data::crypto::NIST::auto_generate_with_additional_entropy<nist>>;
                Secure = std::static_pointer_cast<source> (
                    std::shared_ptr<secure> (
            ...
            using nist = data::crypto::NIST::HMAC_DRBG<data::crypto::hash::SHA2_384>;
            if (o.additional) {
                using secure = automatic_reseed<data::crypto::NIST::auto_generate_with_additional_entropy<nist>>;
                Secure = std::static_pointer_cast<source> (
                    std::shared_ptr<secure> (
            ...
            using nist = data::crypto::NIST::Hash_DRBG<data::crypto::hash::SHA2_512>;
            if (o.additional) {
                using secure = automatic_reseed<data::crypto::NIST::auto_generate_with_additional_entropy<nist>>;
                Secure = std::static_pointer_cast<source> (
                    std::shared_ptr<secure> (
